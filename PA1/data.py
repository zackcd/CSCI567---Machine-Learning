...
def sample_decision_tree_data():
    ...
    labels = [0, 0, 1, 1]
    #features = [['a', 'b'], ['b', 'b'], ['b', 'b'], ['c', 'b']]
    #labels = [0, 0, 1, 1]
    #features = [['c', 'b'], ['a', 'b'], ['b', 'a'], ['b', 'c']]
    #labels = [1, 0, 0, 1]
    #features = [['a', 'b', 'c'], ['b', 'a', 'a'], ['d', 'c', 'c'], ['c', 'b', 'b'], ['b', 'c', 'a']]
    #labels = [0, 0, 1, 1, 1]
    #features = [['b', 'b', 'b'], ['b', 'b', 'a'], ['a', 'a', 'b'], ['b', 'a', 'a']]
    #labels = [1, 1, 2, 2]
...
def sample_decision_tree_test():
    ...
    #labels = [0, 0, 0]
    #features = [['a', 'b'], ['b', 'a'], ['b', 'b'], ['c', 'a'], ['c', 'b'], ['b', 'c']]
    #labels = [0, 0, 0, 1, 1, 1]
    features = [['a', 'b'], ['b', 'a'], ['b', 'b'], ['b', 'c']]
    labels = [0, 0, 1, 0]
    return features, labels
